[![Build Status](https://dev.azure.com/mydevops25/user25devops/_apis/build/status/monolith-classic-CI?branchName=master)](https://dev.azure.com/mydevops25/user25devops/_build/latest?definitionId=2&branchName=master)
